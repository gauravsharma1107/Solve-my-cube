...
export const TRANSLATIONS: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    learner_lbl_desc: 'Layer-by-Layer: The classic, intuitive method ideal for first-time cubers.',
  ...
  hi: {
    ...
    learner_lbl_desc: 'परत-दर-परत (LBL): शुरुआती लोगों के लिए सबसे सरल और समझने योग्य विधि।',
  ...
  'hi-hinglish': {
    ...
    learner_lbl_desc: 'लेयर-बाय-लेयर (LBL): पहली बार सीखने वालों के लिए सबसे आसान और बेस्ट तरीका।',
  ...
  hinglish: {
    ...
    learner_lbl_desc: 'Layer-by-Layer (LBL): First-time cubers ke liye sabse simple aur intuitive method.',
